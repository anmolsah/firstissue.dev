...
const EliteContributorBadge = ({ earned = false, onClick, variant = "card" }) => {
  ...
  const renderContent = () => (
    <div className={`relative ${variant === "raw" ? "w-full h-full" : "w-28 h-28"} flex items-center justify-center`}>
      {earned ? (
        <svg
          viewBox="0 0 200 200"
          className="w-full h-full drop-shadow-[0_0_15px_rgba(245,158,11,0.25)]"
        >
          <defs>
          ...
          {/* Backdrop Glow */}
          <circle cx="100" cy="100" r="80" fill="url(#amberGlow)" />
          ...
          <g ref={outerRingRef}>
            <polygon
              ...
              strokeOpacity="0.5"
            />
            <circle cx="100" cy="10" r="3" fill="#FBBF24" />
            <circle cx="178" cy="55" r="3" fill="#FBBF24" />
            <circle cx="178" cy="145" r="3" fill="#FBBF24" />
            <circle cx="100" cy="190" r="3" fill="#FBBF24" />
            <circle cx="22" cy="145" r="3" fill="#FBBF24" />
            <circle cx="22" cy="55" r="3" fill="#FBBF24" />
          </g>
          ...
          {/* Floating Sparkles */}
          <g>
            <circle ref={el => particlesRef.current[0] = el} cx="68" cy="62" r="2" fill="#FEF3C7" opacity="0.6" />
            <circle ref={el => particlesRef.current[1] = el} cx="132" cy="62" r="2.5" fill="#FEF3C7" opacity="0.4" />
            <circle ref={el => particlesRef.current[2] = el} cx="72" cy="138" r="2.5" fill="#FEF3C7" opacity="0.5" />
            <circle ref={el => particlesRef.current[3] = el} cx="128" cy="138" r="2" fill="#FEF3C7" opacity="0.6" />
          </g>
          ...
          {/* Big central achievement number "50" */}
          <g ref={numberRef}>
            <text
              x="100"
              y="114"
        ...
        <div className="w-24 h-24 rounded-full bg-[#0A0B10]/20 border border-white/[0.03] flex items-center justify-center relative group-hover:bg-white/[0.02] transition-all duration-300">
          <svg viewBox="0 0 200 200" className="w-full h-full opacity-20 filter grayscale">
            ...
            <text x="100" y="114" fontFamily="sans-serif" fontSize="44" fontWeight="900" fill="#64748B" textAnchor="middle">50</text>
          </svg>
  ...
  return (
    <BadgeContainer earned={earned} onClick={onClick} title="Elite Contributor">
      {renderContent()}
    </BadgeContainer>
  );
};

export default EliteContributorBadge;
