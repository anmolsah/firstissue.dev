  ...
  return (
    <footer className="w-full bg-[#0B0C10] border-t border-zinc-800/60 py-8 text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 py-6 text-center md:text-left">
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full md:w-auto">
            <Link to="/" className="text-xs font-bold tracking-tight text-white hover:opacity-85">
              FirstIssue.dev
            </Link>
            <span className="text-zinc-800 hidden sm:inline">|</span>
            <div className="flex flex-wrap justify-center sm:justify-start items-center gap-x-6 gap-y-3 text-zinc-500">
          ...
          <div className="text-zinc-650 font-medium">
