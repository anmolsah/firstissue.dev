        ...
        {isOpen && (
          <>
            ...
            >
              ...
              {/* Chat Message Logs / Sign In required lock */}
              {!user ? (
                <div className="flex-1 flex flex-col items-center justify-center p-8 text-center space-y-6">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <h3 className="text-lg font-bold text-white tracking-tight">Sign In Required</h3>
                    <p className="text-xs text-gray-400 leading-relaxed max-w-sm">
                      FirstMate is only available to registered contributors. Please log in or sign up with GitHub to start chatting.
                    </p>
                  </div>
                  ...
                  <a
                    href="/login"
                    onClick={() => setIsOpen(false)}
                    className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-[#00ADB5] hover:brightness-110 text-white text-xs font-bold rounded-xl transition-all duration-200 shadow-md border border-white/10"
                  >
                    Log In / Sign Up
                  </a>
                </div>
                                ...
                                {msg.sources.map((src, srcIdx) => {
                                  ...
                                  return isUrl ? (
                                    <a
                                      ...
                                      className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded bg-[#1e222b] text-[10px] text-[#00ADB5] border border-[#00ADB5]/10 hover:border-[#00ADB5]/30 hover:bg-[#252a36] transition-colors"
                                    >
                                    ...
                                    <div
                                      key={srcIdx}
                                      className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded bg-[#1e222b] text-[10px] text-gray-400 border border-white/5"
                                    >
                                      <span>{src.title || src.source}</span>
                                    </div>
                                  );
